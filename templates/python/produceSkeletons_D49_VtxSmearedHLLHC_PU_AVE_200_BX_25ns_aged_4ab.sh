...
action() {
  ...
  local custom="--customise SLHCUpgradeSimulations/Configuration/aging.customise_aging_3000,SimCalorimetry/HGCalSimProducers/hgcalDigitizer_cfi.HGCal_setEndOfLifeNoise_4000,Configuration/DataProcessing/Utils.addMonitoring"
